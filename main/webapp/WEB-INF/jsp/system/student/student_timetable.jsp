...
<head>
    ...
    <script src="https://cdn.bootcss.com/bootstrap/4.0.0/js/bootstrap.min.js" integrity="sha384-JZR6Spejh4U02d8jOt6vLEHfe/JQGiRRSQQxSfFWpi1MquVdAyjUar5+76PVCmYl" crossorigin="anonymous"></script>pt>
</head>
<body>
<div class="page">
    <!--头部-->
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table table-bordered">
                                            ...
                                            <tbody>
                                            <c:forEach items="${schedules}" var="item" varStatus="s">
                                                <tr>
                                                    <th scope="row">礼拜${item.week}</th>
                                                    <td>${item.am1}</td>
                                                    <td>${item.am2}</td>
                                                    <td>${item.pm1}</td>
                                                    <td>${item.pm2}</td>
